-- CreateEnum
CREATE TYPE "Role" AS ENUM ('NORMAL', 'ADMIN', 'SUPER_ADMIN', 'DELIVERER');
...
-- CreateIndex
CREATE UNIQUE INDEX "deliverers_user_id_key" ON "deliverers"("user_id");
...
-- AddForeignKey
ALTER TABLE "deliverers" ADD CONSTRAINT "deliverers_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
