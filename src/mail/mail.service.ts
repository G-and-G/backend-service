...
export class MailService {
    ...
    async sendPasswordResetSuccessfulEmail({ email, names }: { email: string, token: string, names: string }) {
        const mailOptions: nodemailer.SendMailOptions = {
            to: email,
    ...
    async sendEmailVerificationSuccessfulEmail({ email, names }: { email: string, token: string, names: string }) {
        const mailOptions: nodemailer.SendMailOptions = {
            to: email,
            subject: 'Password reset successful',
