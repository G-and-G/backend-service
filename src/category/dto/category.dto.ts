...
export class CreateCategoryDto{
    @ApiProperty({description:"description of the new category",example:'This is a category of different drinks available'})
    @IsString()
    @IsNotEmpty()
    ...
    @IsString()
    @ApiProperty({description:"url of the image to the label of the category",example:'https://images.com/img.png'})
    @IsNotEmpty()
    image:string;
}